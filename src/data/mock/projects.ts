...
export const mockProjects: Project[] = [
  {
    ...
    tags: ['Platform', 'Autonomous Vehicles', 'Fleet Management', 'B2B', 'API', 'RBAC', 'UN R155'],
    date: '2022-01-01',
    featured: true,
    status: 'published',
    ...
    metrics: [
      {label: 'Onboarding Latency', value: '10d → 3d', context: '70% reduction'},
      {label: 'Vehicles Onboarded', value: '500', context: 'across 2 fleet operators'},
      {label: 'Markets', value: 'EU + US', context: 'with regulatory compliance'},
    ],
    challenge:
    ...
    techStack: ['Vehicle-to-Cloud APIs', 'mTLS', 'RBAC', 'eSIM/SIM Management', 'REST APIs', 'HSM', 'GDPR', 'UN R155'],
    flowDiagram: '/projects/vehicle-lifecycle-flow.svg',
    flowDiagramAlt: 'Vehicle lifecycle flow: 7 phases from factory certificate provisioning through logistics, first cloud connection, certificate validation, eSIM remote SIM provisioning, platform activation, to B2B fleet handover',
  },
  {
    id: 'p2',
    ...
    tags: ['Platform', 'eSIM', 'Connectivity', 'IoT', 'Autonomous Vehicles', 'API', 'GSMA'],
    date: '2022-06-01',
    featured: true,
    status: 'published',
    company: 'diconium (Volkswagen Group)',
    ...
    techStack: ['GSMA RSP (SGP.02)', 'SM-DP+ Server', 'eSIM / embedded SIM', 'mTLS', 'REST APIs', 'MNO Integration'],
    flowDiagram: '/projects/sim-management-flow.svg',
    flowDiagramAlt: 'SIM management flow: 5 steps from vehicle eSIM bootstrap profile through platform authentication, MNO selection across 4 partners (2 EU, 2 US), SM-DP+ encrypted profile push, to operational profile active',
  },
  {
    id: 'p3',
    ...
    subtitle: 'UX and funnel optimisation for customer-facing vehicle pages',
    summary:
      'Owned UX and funnel optimisation for VW Group\'s customer-facing product pages, increasing engagement by 8% and improving downstream appointment conversion by 2% through redesigned information architecture and a guided virtual booking flow.',
    tags: ['UX', 'Funnel Optimisation', 'Product Analytics', 'A/B Testing', 'Customer-Facing'],
    date: '2022-03-01',
    featured: false,
    status: 'published',
    company: 'diconium (Volkswagen Group)',
    ...
    metrics: [
      {label: 'Page Engagement', value: '+8%', context: 'customer-facing product pages'},
      {label: 'Appointment Conversion', value: '+2%', context: 'downstream booking flow'},
      {label: 'Approach', value: 'Data-driven', context: 'A/B testing + UX research'},
    ],
    challenge:
    ...
    results: [
      ...
      'Product analytics instrumentation gave the business deeper funnel visibility for ongoing optimisation',
    ],
    techStack: ['Product Analytics', 'A/B Testing', 'UX Research', 'Funnel Analysis', 'Information Architecture'],
    flowDiagram: '/projects/vw-digital-flow.svg',
    flowDiagramAlt: 'VW digital experience user journey: 4 stages from product page through redesigned information architecture and virtual booking flow to appointment confirmation',
  },
  {
    id: 'p4',
    ...
    featured: true,
    status: 'published',
    company: 'Akelius Residential Property AB',
    ...
    techStack: ['React', 'TypeScript', 'GraphQL', 'Server-Side Rendering (SSR)', 'Node.js', 'AWS'],
    flowDiagram: '/projects/akelius-analytics-flow.svg',
    flowDiagramAlt: 'Akelius construction lifecycle flow: 5 stages from multi-department source data through manual handover pain point, automated lifecycle platform, analytics dashboard, to better investment decisions',
  },
  {
    id: 'p5',
    ...
    techStack: ['React', 'Redux-Saga', 'TypeScript', 'Data Visualisation', 'Geospatial APIs', 'Agile / Scrum'],
    flowDiagram: '/projects/wework-decision-flow.svg',
    flowDiagramAlt: 'WeWork site selection flow: 5 steps from location data and market analysis through the analytics tool and site scoring to the final expansion decision',
  },
];
